...
@Event(DefendantFinancialMeansUpdateRequested.EVENT_NAME)
public class DefendantFinancialMeansUpdateRequested implements Serializable {

    public static final String EVENT_NAME = "stagingbulkscan.events.defendant-financial-means-update-requested";
    ...
    @JsonCreator
    public DefendantFinancialMeansUpdateRequested(@JsonProperty("scanEnvelopeId") final UUID scanEnvelopeId,
